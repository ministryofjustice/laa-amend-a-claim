...
public interface AmendmentFieldValidator {
  ...
  default void addUniqueFieldError(ClaimViewField<?> field, String errorCode,
      Errors errors) {
    addUniqueFieldError(field, errorCode, new String[] {}, errors);
  }

  default void addUniqueFieldError(ClaimViewField<?> field, String errorCode, Object[] args,
      Errors errors) {
