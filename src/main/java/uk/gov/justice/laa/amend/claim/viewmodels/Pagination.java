...
public class Pagination {
    ...
    public Pagination(int totalNumberOfResults, int numberOfResultsPerPage, int currentPage, String href) {
        ...
        this.results =
                new PaginationResults(totalNumberOfResults, numberOfResultsPerPage, currentPage, totalNumberOfPages);
    }
    ...
    private List<PaginationItem> buildPaginationItems(int currentPage, int totalNumberOfPages, String href) {
            ...
            for (int page = 1; page <= totalNumberOfPages; page++) {
                if (page == 1 || Math.abs(page - currentPage) <= 1 || page == totalNumberOfPages) {
                    PaginationItem paginationItem =
                            new PaginationItem(page, totalNumberOfPages, buildHref(href, page), page == currentPage);
