...
public abstract class E2eBaseTest extends BaseTest {
  ...
  protected void submitWithAddedProfitCostsAndAssessedTotalsAndAllowedTotals(
  ...
  private void checkAssessedClaim(
      String assessedTotalVat,
      String assessedTotalInclVat,
      String allowedTotalVat,
      String allowedTotalInclVat) {
    ...
    claimDetails.assertAssessedTotals(
        "Assessed total VAT", "Not applicable", "Not applicable", assessedTotalVat);
    claimDetails.assertAssessedTotals(
  ...
  private void addAssessedTotals(
      ReviewAndAmendPage review, String assessedTotalVat, String assessedTotalInclVat) {
  ...
  private void addAllowedTotals(
      ReviewAndAmendPage review, String allowedTotalVat, String allowedTotalInclVat) {
