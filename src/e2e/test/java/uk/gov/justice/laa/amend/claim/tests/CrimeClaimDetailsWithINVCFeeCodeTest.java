...
@Epic("ClaimDetails")
@Feature("Crime claim with INVC code")
public class CrimeClaimDetailsWithINVCFeeCodeTest extends E2eBaseTest {
  ...
  @Test
  @DisplayName(
      "E2E: Assessed ClaimDetails - Reduced (still escaped) - Show claim Assessed/Allowed totals")
  void reduced() {
    submitWithAddedProfitCostsAndAssessedTotalsAndAllowedTotals("reduced-still-escaped");
  }

  @Test
  @DisplayName(
      "E2E: Assessed ClaimDetails - Reduced (fixed fee) - Show claim Assessed/Allowed totals")
