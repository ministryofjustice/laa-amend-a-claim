...
class AssessmentMapperTest {
    ...
    void testMapCivilClaimToAssessment() {
        ...
        assertEquals(claim.getClaimSummaryFeeId(), assessment.getClaimSummaryFeeId().toString());
    ...
    void testMapAssessedTotalVat_whenAmendedValueIsNull() {
        ...
        claim.setAssessedTotalVat(AssessedClaimField.builder().build());
    ...
    void testMapAssessedTotalInclVat_whenAmendedValueIsNull() {
        CivilClaimDetails claim = new CivilClaimDetails();
        claim.setAssessedTotalInclVat(AssessedClaimField.builder().build());
    ...
    void shouldMapAssessmentToCrimeClaimDetails() {
        ...
        ClaimField allowedTotalVatField = AllowedClaimField.builder().key(ALLOWED_TOTAL_VAT).submitted(345).calculated(345).build();
        ClaimField allowedTotalInclVatField = AllowedClaimField.builder().key(ALLOWED_TOTAL_INCL_VAT).submitted(348).calculated(348).build();
