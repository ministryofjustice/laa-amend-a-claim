...
public class SessionUtilsTest {
    ...
    class GetClaimTests {
        ...
        void nullSessionThrowsException() {
            assertThrows(NoClaimInSessionException.class, () -> SessionUtils.getClaim(null, SUBMISSION_ID, CLAIM_ID));
        }
    ...
    class GetValidClaimTests {
        ...
        void nonValidClaimThrowsException(ClaimStatus status) {
            ...
            var exception = assertThrows(
                    ResponseStatusException.class, () -> SessionUtils.getValidClaim(session, SUBMISSION_ID, CLAIM_ID));
