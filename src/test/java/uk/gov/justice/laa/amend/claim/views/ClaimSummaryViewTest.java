...
class ClaimSummaryViewTest extends ViewTestBase {
    ...
    void testCivilClaimPage() throws Exception {
        ...
        assertSummaryListRowContainsValues(summaryList1.get(5), "Area of law", "LEGAL_HELP");
        assertSummaryListRowContainsValues(summaryList1.get(6), "Category of law", "TEST");
        ...
        assertSummaryListRowContainsValues(summaryList1.get(9), "Matter type 1", "IMLB");
        assertSummaryListRowContainsValues(summaryList1.get(10), "Matter type 2", "AHQS");
        ...
        assertSummaryListRowContainsValues(summaryList2.get(14), "Total", "£200.00", "£100.00");
    }
    ...
    void testAssessedClaimPage() throws Exception {
        ...
        assertSummaryListRowContainsValues(summaryList2.get(10), "Home office interview", "£200.00", "£100.00", "£300.00");
        assertSummaryListRowContainsValues(summaryList2.get(11), "Substantive hearing", "£200.00", "£100.00", "£300.00");
        assertSummaryListRowContainsValues(summaryList2.get(12), "Adjourned hearing fee", "£200.00", "£100.00", "£300.00");
    ...
    void testCrimeClaimPage() throws Exception {
        ...
        assertSummaryListRowContainsValues(summaryList1.getFirst(), "Client name", "John Doe");
        assertSummaryListRowContainsValues(summaryList1.get(1), "Unique file number (UFN)", "Not applicable");
        assertSummaryListRowContainsValues(summaryList1.get(2), "Provider account number", "0P322F");
        assertSummaryListRowContainsValues(summaryList1.get(3), "Date submitted", "15 June 2020 at 09:30:00");
        assertSummaryListRowContainsValues(summaryList1.get(4), "Area of law", "CRIME");
        assertSummaryListRowContainsValues(summaryList1.get(5), "Category of law", "Not applicable");
        assertSummaryListRowContainsValues(summaryList1.get(6), "Fee code", "FC");
        assertSummaryListRowContainsValues(summaryList1.get(7), "Fee code description", "FCD");
        assertSummaryListRowContainsValues(summaryList1.get(8), "Police Station / Court / Prison ID", "POLICE_STATION_COURT_PRISON");
        assertSummaryListRowContainsValues(summaryList1.get(9), "Scheme ID", "SCHEME");
        ...
        assertSummaryListRowContainsValues(summaryList2.get(8), "Total", "£200.00", "£100.00");
    }
