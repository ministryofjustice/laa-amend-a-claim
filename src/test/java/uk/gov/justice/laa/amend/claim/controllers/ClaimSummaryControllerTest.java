...
public class ClaimSummaryControllerTest {
    ...
    private static CivilClaimDetails createClaim() {
        ...
        claim.setVatClaimed(new ClaimField(VAT, 80, 75, 78, ClaimFieldType.OTHER));
        claim.setFixedFee(new ClaimField(FIXED_FEE, 500, 480, 490, ClaimFieldType.OTHER));
        claim.setNetProfitCost(new ClaimField(NET_PROFIT_COST, 600, 580, 590, ClaimFieldType.OTHER));
        claim.setNetDisbursementAmount(new ClaimField(NET_DISBURSEMENTS_COST, 200, 190, 195, ClaimFieldType.OTHER));
        claim.setTotalAmount(new ClaimField(TOTAL, 1380, 1325, 1350, ClaimFieldType.CALCULATED_TOTAL));
        claim.setDisbursementVatAmount(new ClaimField(DISBURSEMENT_VAT, 40, 38, 39, ClaimFieldType.OTHER));

        // Civil-specific fields
        claim.setDetentionTravelWaitingCosts(new ClaimField(DETENTION_TRAVEL_COST, BigDecimal.valueOf(50), BigDecimal.valueOf(55), ClaimFieldType.OTHER));
        claim.setJrFormFillingCost(new ClaimField(JR_FORM_FILLING, BigDecimal.valueOf(30), BigDecimal.valueOf(35), ClaimFieldType.OTHER));
        ...
        claim.setCounselsCost(new ClaimField(COUNSELS_COST, BigDecimal.valueOf(200), BigDecimal.valueOf(220), ClaimFieldType.OTHER));
