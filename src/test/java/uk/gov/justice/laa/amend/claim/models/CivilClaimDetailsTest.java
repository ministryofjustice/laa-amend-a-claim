...
public class CivilClaimDetailsTest {
    ...
    class SetNilledValuesTests {
        ...
        void setsValuesToNilledStatus() {
            ...
            Assertions.assertEquals(
                    BigDecimal.ZERO, claim.getNetDisbursementAmount().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.ZERO, claim.getDisbursementVatAmount().getAssessed());
            Assertions.assertEquals(BigDecimal.ZERO, claim.getCounselsCost().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.ZERO, claim.getDetentionTravelWaitingCosts().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.ZERO, claim.getJrFormFillingCost().getAssessed());
            ...
            Assertions.assertEquals(
                    BigDecimal.ZERO, claim.getSubstantiveHearing().getAssessed());
            Assertions.assertEquals(BigDecimal.ZERO, claim.getAssessedTotalVat().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.ZERO, claim.getAssessedTotalInclVat().getAssessed());
            Assertions.assertEquals(BigDecimal.ZERO, claim.getAllowedTotalVat().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.ZERO, claim.getAllowedTotalInclVat().getAssessed());
        }
    }
    ...
    class SetReducedToFixedFeeTests {
        ...
        void setsValuesToReducedToFixedFee() {
            ...
            Assertions.assertEquals(
                    BigDecimal.valueOf(200), claim.getNetDisbursementAmount().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(200), claim.getDisbursementVatAmount().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(200), claim.getCounselsCost().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(200),
                    claim.getDetentionTravelWaitingCosts().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(200), claim.getJrFormFillingCost().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(200), claim.getAdjournedHearing().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(200), claim.getCmrhTelephone().getAssessed());
            Assertions.assertEquals(BigDecimal.valueOf(200), claim.getCmrhOral().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(200), claim.getHoInterview().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(200), claim.getSubstantiveHearing().getAssessed());
    ...
    class SetPaidInFullValuesTests {
        ...
        void paidInFull() {
            ...
            Assertions.assertEquals(
                    BigDecimal.valueOf(100), claim.getNetProfitCost().getAssessed());
            Assertions.assertEquals(true, claim.getVatClaimed().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(100), claim.getNetDisbursementAmount().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(100), claim.getDisbursementVatAmount().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(100), claim.getCounselsCost().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(100),
                    claim.getDetentionTravelWaitingCosts().getAssessed());
            Assertions.assertEquals(
                    BigDecimal.valueOf(100), claim.getJrFormFillingCost().getAssessed());
