...
public class DbSeedSmokeTest extends BaseTest {
  ...
  private void checkSeededSubmissionData(String submissionId, String bulkSubmissionId)
      throws SQLException {
  ...
  private void checkSeededClaimData(String claimId, String submissionId, String ufn)
      throws SQLException {
  ...
  private void checkSeededClaimSummaryFeeData(String claimSummaryFeeId, String claimId)
      throws SQLException {
  ...
  private void checkSeededCalculatedFeeDetailData(
      String calculatedFeeDetailId, String claimSummaryFeeId, String claimId) throws SQLException {
