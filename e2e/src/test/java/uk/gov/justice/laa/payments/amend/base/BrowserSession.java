...
import uk.gov.justice.laa.payments.amend.config.EnvConfig;
import uk.gov.justice.laa.payments.amend.pages.LoginPage;

/**
 * The {@code BrowserSession} class provides a managed browser session for automated UI tests using
 * the Playwright library. It handles browser initialization, login, and cleanup within a reusable
 * browser context.
 */
