...
import static uk.gov.justice.laa.payments.amend.helpers.PageHelper.summaryListRowByLabel;
import static uk.gov.justice.laa.payments.amend.helpers.PageHelper.tableRowByLabel;
...
public class ClaimDetailsPage extends LaaPage {
  ...
  public ClaimDetailsPage(Page page) {
    ...
    this.addAssessmentOutcomeButton =
        page.getByRole(
            AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Add assessment outcome"));

    this.updateAssessmentOutcomeButton =
        page.getByRole(
            AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Update assessment outcome"));
