package uk.gov.justice.laa.payments.amend.bulkupload.civil;

import static uk.gov.justice.laa.payments.amend.bulkupload.civil.CivilClaimSchemaProvider.ASSESSMENT_OUTCOME;
import static uk.gov.justice.laa.payments.amend.bulkupload.civil.CivilClaimSchemaProvider.COUNSEL_COSTS;
import static uk.gov.justice.laa.payments.amend.bulkupload.civil.CivilClaimSchemaProvider.DISBURSEMENTS;
import static uk.gov.justice.laa.payments.amend.bulkupload.civil.CivilClaimSchemaProvider.DISBURSEMENTS_VAT;
import static uk.gov.justice.laa.payments.amend.bulkupload.civil.CivilClaimSchemaProvider.OFFICE_CODE;
import static uk.gov.justice.laa.payments.amend.bulkupload.civil.CivilClaimSchemaProvider.PROFIT_COST;
import static uk.gov.justice.laa.payments.amend.bulkupload.civil.CivilClaimSchemaProvider.TOTAL_ALLOWED_INCLUDING_VAT;
import static uk.gov.justice.laa.payments.amend.bulkupload.civil.CivilClaimSchemaProvider.TOTAL_ALLOWED_VAT;
import static uk.gov.justice.laa.payments.amend.bulkupload.civil.CivilClaimSchemaProvider.UFN;
