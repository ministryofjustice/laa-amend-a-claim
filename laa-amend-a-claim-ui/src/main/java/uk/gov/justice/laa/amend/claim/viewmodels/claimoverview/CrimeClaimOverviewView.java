...
import static uk.gov.justice.laa.amend.claim.viewmodels.claimoverview.ClaimOverviewView.putField;
import static uk.gov.justice.laa.amend.claim.viewmodels.viewfield.ClaimDetailsViewField.AREA_OF_LAW;
...
import static uk.gov.justice.laa.amend.claim.viewmodels.viewfield.ClaimDetailsViewField.CATEGORY_OF_LAW;
import static uk.gov.justice.laa.amend.claim.viewmodels.viewfield.ClaimDetailsViewField.CLIENT_NAME;
...
import static uk.gov.justice.laa.amend.claim.viewmodels.viewfield.ClaimDetailsViewField.ESCAPED;
import static uk.gov.justice.laa.amend.claim.viewmodels.viewfield.ClaimDetailsViewField.FEE_CODE;
import static uk.gov.justice.laa.amend.claim.viewmodels.viewfield.ClaimDetailsViewField.FEE_CODE_DESCRIPTION;
import static uk.gov.justice.laa.amend.claim.viewmodels.viewfield.ClaimDetailsViewField.FIXED_FEE;
import static uk.gov.justice.laa.amend.claim.viewmodels.viewfield.ClaimDetailsViewField.OFFICE_CODE;
...
import static uk.gov.justice.laa.amend.claim.viewmodels.viewfield.ClaimDetailsViewField.SUBMITTED_DATE;
import static uk.gov.justice.laa.amend.claim.viewmodels.viewfield.ClaimDetailsViewField.TOTAL;
...
import static uk.gov.justice.laa.amend.claim.viewmodels.viewfield.ClaimDetailsViewField.VAT_REQUESTED;
