package uk.gov.justice.laa.amendaclaim.controller;

import static uk.gov.justice.laa.amendaclaim.constants.SessionConstants.SUBMISSION_ID;
import static uk.gov.justice.laa.amendaclaim.constants.ViewSubmissionNavigationTab.CLAIM_DETAILS;
...
import uk.gov.justice.laa.amendaclaim.builder.SubmissionClaimDetailsBuilder;
import uk.gov.justice.laa.amendaclaim.builder.SubmissionMatterStartsDetailsBuilder;
import uk.gov.justice.laa.amendaclaim.builder.SubmissionSummaryBuilder;
import uk.gov.justice.laa.amendaclaim.client.DataClaimsRestClient;
import uk.gov.justice.laa.amendaclaim.constants.ViewSubmissionNavigationTab;
import uk.gov.justice.laa.amendaclaim.dto.submission.SubmissionClaimDetails;
import uk.gov.justice.laa.amendaclaim.dto.submission.SubmissionMatterStartsDetails;
import uk.gov.justice.laa.amendaclaim.dto.submission.SubmissionSummary;
import uk.gov.justice.laa.amendaclaim.exception.SubmitBulkClaimException;
