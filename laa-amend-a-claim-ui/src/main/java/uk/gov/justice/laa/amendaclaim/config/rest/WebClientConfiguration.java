package uk.gov.justice.laa.amendaclaim.config.rest;
...
public class WebClientConfiguration {
  ...
  /**
   * Creates a {@link uk.gov.justice.laa.amendaclaim.client.DataClaimsRestClient} bean to
   * communicate with the Claims API using a WebClient instance.
   *
   ...
   * @return An instance of {@link uk.gov.justice.laa.amendaclaim.client.DataClaimsRestClient} for
