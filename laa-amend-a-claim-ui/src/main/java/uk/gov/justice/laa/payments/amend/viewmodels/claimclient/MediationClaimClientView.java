...
import static uk.gov.justice.laa.payments.amend.viewmodels.viewfield.MediationClaimDetailsViewField.CLIENT_2_DATE_OF_BIRTH;
import static uk.gov.justice.laa.payments.amend.viewmodels.viewfield.MediationClaimDetailsViewField.CLIENT_2_DISABILITY;
import static uk.gov.justice.laa.payments.amend.viewmodels.viewfield.MediationClaimDetailsViewField.CLIENT_2_ETHNICITY;
import static uk.gov.justice.laa.payments.amend.viewmodels.viewfield.MediationClaimDetailsViewField.CLIENT_2_FORENAME;
import static uk.gov.justice.laa.payments.amend.viewmodels.viewfield.MediationClaimDetailsViewField.CLIENT_2_GENDER;
import static uk.gov.justice.laa.payments.amend.viewmodels.viewfield.MediationClaimDetailsViewField.CLIENT_2_POSTCODE;
...
import static uk.gov.justice.laa.payments.amend.viewmodels.viewfield.MediationClaimDetailsViewField.IS_POSTAL_APPLICATION_ACCEPTED;
import static uk.gov.justice.laa.payments.amend.viewmodels.viewfield.MediationClaimDetailsViewField.POSTCODE;
