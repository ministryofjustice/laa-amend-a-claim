...
import static uk.gov.justice.laa.payments.amend.config.security.SecurityConstants.PERMISSIONS_POLICY;
import static uk.gov.justice.laa.payments.amend.service.DummyUserSecurityService.createAuthToken;
...
public class SecurityConfigIntegrationTest extends RedisSetup {
  ...
  @ParameterizedTest
  @ValueSource(
      strings = {"/", "/js/app.min.js", "/js/accessible-autocomplete.min.js", "/css/app.min.css"})
  @WithMockUser(roles = "USER")
