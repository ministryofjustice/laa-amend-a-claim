...
public abstract class AmendmentsBaseTest extends ViewTestBase {
  ...
  AmendmentsBaseTest() {
    ...
    amendStageReachedUrl =
        "/submissions/%s/claims/%s/amendments/amend-stage-reached".formatted(submissionId, claimId);
