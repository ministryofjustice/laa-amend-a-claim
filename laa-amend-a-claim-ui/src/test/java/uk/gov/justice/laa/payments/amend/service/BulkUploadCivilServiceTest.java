...
import static uk.gov.justice.laa.payments.amend.models.BulkUploadResult.BulkUploadStatus.VALIDATION_FAILURE;
import static uk.gov.justice.laa.payments.amend.resources.MockClaimsFunctions.createAllowedTotalInclVatField;
import static uk.gov.justice.laa.payments.amend.resources.MockClaimsFunctions.createAllowedTotalVatField;
import static uk.gov.justice.laa.payments.amend.resources.MockClaimsFunctions.createAssessedTotalInclVatField;
import static uk.gov.justice.laa.payments.amend.resources.MockClaimsFunctions.createAssessedTotalVatField;
import static uk.gov.justice.laa.payments.amend.resources.MockClaimsFunctions.createCounselCostField;
import static uk.gov.justice.laa.payments.amend.resources.MockClaimsFunctions.createDisbursementCostField;
import static uk.gov.justice.laa.payments.amend.resources.MockClaimsFunctions.createDisbursementVatCostField;
import static uk.gov.justice.laa.payments.amend.resources.MockClaimsFunctions.createNetProfitCostField;
...
import uk.gov.justice.laa.payments.amend.bulkupload.BulkUploadError;
import uk.gov.justice.laa.payments.amend.bulkupload.BulkUploadHelper;
import uk.gov.justice.laa.payments.amend.bulkupload.CsvHeaderValidator;
import uk.gov.justice.laa.payments.amend.bulkupload.CsvRowMapper;
import uk.gov.justice.laa.payments.amend.bulkupload.CsvSchemaProvider;
import uk.gov.justice.laa.payments.amend.bulkupload.civil.BulkUploadCivilClaim;
import uk.gov.justice.laa.payments.amend.mappers.ClaimMapper;
import uk.gov.justice.laa.payments.amend.models.BulkUploadResult;
import uk.gov.justice.laa.payments.amend.models.BulkUploadValidationOutcome;
...
class BulkUploadCivilServiceTest {
  ...
  @Mock CsvSchemaProvider<BulkUploadCivilClaim> schemaProvider;

  @Mock CsvRowMapper<BulkUploadCivilClaim> rowMapper;

  @Mock CsvHeaderValidator csvHeaderValidator;

  @Mock BulkUploadHelper bulkUploadHelper;

  @Mock AssessmentService assessmentService;

  @Mock ClaimMapper claimMapper;

  @InjectMocks BulkUploadCivilService service;
