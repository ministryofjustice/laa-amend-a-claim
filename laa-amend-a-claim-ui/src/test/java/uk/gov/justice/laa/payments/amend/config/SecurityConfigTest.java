...
import uk.gov.justice.laa.payments.amend.config.security.SecurityConfig;
...
public class SecurityConfigTest {
  ...
  class SecurityConfigGetAuthoritiesTest {
    ...
    void mapRolesToAuthoritiesWhenRolesAreCommaSeparated() {
      ...
      assertThat(result)
          ...
          .containsExactlyInAnyOrder(
              Role.ROLE_CLAIM_AMENDMENTS_CASEWORKER.name(),
              Role.ROLE_ESCAPE_CASE_CASEWORKER.name());
    }
    ...
    void mapRolesToAuthoritiesWhenRolesAreInList() {
      Map<String, Object> attributes =
          Map.of(
              "LAA_APP_ROLES",
              List.of(
                  "Amend a Claim - Claim Amendments Caseworker",
                  "Amend a Claim - Escape Case Caseworker"));
    ...
    void ignoresUnknownRoles() {
      Map<String, Object> attributes =
          Map.of("LAA_APP_ROLES", List.of("A role that's not in the Role enum"));
