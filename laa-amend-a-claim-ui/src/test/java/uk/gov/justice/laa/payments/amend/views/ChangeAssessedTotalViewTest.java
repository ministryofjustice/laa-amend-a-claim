...
import uk.gov.justice.laa.payments.amend.controllers.ChangeAssessedTotalsController;
...
class ChangeAssessedTotalViewTest extends ViewTestBase {
  ...
  void testPage() {
    ...
    assertPageHasHint(
        doc, "assessed-total-vat-hint", "Enter the amount of assessed VAT for the claim");
    assertPageHasHint(
        doc, "assessed-total-incl-vat-hint", "Enter the total assessed value of the claim");
