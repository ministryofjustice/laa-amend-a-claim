package uk.gov.justice.laa.payments.amend.views;
...
import uk.gov.justice.laa.payments.amend.controllers.ClaimReviewController;
...
class ReviewAndAmendViewTest extends ViewTestBase {
  ...
  @MockitoBean ClaimStatusHandler statusHandler;
  ...
  void testCivilClaimPage() {
    ...
    assertTableRowContainsValuesWithChangeLink(
        ...
        "Assessed in full",
        String.format(
            "/submissions/%s/claims/%s/assessment-outcome#assessment-outcome",
    ...
    assertTableRowContainsValuesWithChangeLink(
        ...
        "No",
        String.format(
            "/submissions/%s/claims/%s/assessment-outcome#contingency-assessment",
            submissionId, claimId));
    ...
    assertTableRowContainsValuesWithNoChangeLink(
        totalClaimValueTable.getFirst(), "Assessed total VAT", "£100.00", "£200.00", "£300.00");
    assertTableRowContainsValuesWithNoChangeLink(
        totalClaimValueTable.get(1), "Assessed total incl VAT", "£100.00", "£200.00", "£300.00");
  ...
  void testCivilClaimPageWithMissingAssessedTotals() {
    ...
    Assertions.assertEquals(2, totalClaimValueTable.size());
    assertTableRowContainsValuesWithNoChangeLink(
        totalClaimValueTable.getFirst(), "Assessed total VAT", "£100.00", "£200.00", "");
    assertTableRowContainsValuesWithNoChangeLink(
        totalClaimValueTable.get(1), "Assessed total incl VAT", "£100.00", "£200.00", "");
