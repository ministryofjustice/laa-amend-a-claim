...
public class AllowedTotalFormTest extends FormTest {
  ...
  private void checkViolations(
    ...
    Set<ConstraintViolation<AllowedTotalForm>> violations = validator.validate(form);
    ConstraintViolation<AllowedTotalForm> totalVatViolation =
        getViolation(violations, "allowedTotalVat");
    ConstraintViolation<AllowedTotalForm> totalInclVatViolation =
        getViolation(violations, "allowedTotalInclVat");
