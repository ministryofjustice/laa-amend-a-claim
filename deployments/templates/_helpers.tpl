...
*/}}
{{- define "laa-amend-a-claim.fullname" -}}
...
*/}}
{{- define "laa-amend-a-claim.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "laa-amend-a-claim.fullname" .) .Values.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.serviceAccount.name }}
{{- end }}
{{- end }}

{{- define "laa-amend-a-claim.app.vars" -}}
